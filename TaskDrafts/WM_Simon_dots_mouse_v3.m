...
function WM_Simon_dots_mouse_v3
...
datafilename = strcat('MotorData/WM_Simon_dots_mouse_v3_', subject, '.txt'); 
...
if exist(datafilename)==2
    ...
    if strcmpi(overwrite, 'n')
        ...
        datafilename = strcat('MotorData/WM_Simon_dots_mouse_v3_', newsub, '.txt');
    end
end
...
%             Tcenter = [0, 0];
            ...
            switch CurrentCondition
                case 1 %compatible
                    ...
                    if CurrentSampleIndex == 1 % L/R cue 
...
%name of data output file 
cursor_data_filename = strcat('MotorData/WM_Simon_dots_mouse_v3_', subject, '_cursor_data.mat'); 
