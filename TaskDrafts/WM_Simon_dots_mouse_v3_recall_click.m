...
function WM_Simon_dots_mouse_v3_recall_click
...
datafilename = strcat('MotorData/WM_Simon_dots_mouse_v3_recall_click_', subject, '.txt'); 
...
if exist(datafilename)==2
    ...
    if strcmpi(overwrite, 'n')
        ...
        datafilename = strcat('MotorData/WM_Simon_dots_mouse_v3_recall_click_', newsub, '.txt');
    end
end
...
%name of data output file 
cursor_data_filename = strcat('MotorData/WM_Simon_dots_mouse_v3_recall_click_', subject, '_cursor_data.mat'); 
