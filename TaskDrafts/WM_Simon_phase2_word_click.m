...
function WM_Simon_phase2_word_click
...
datafilename = strcat('MotorData/WM_Simon_phase2_word_click _', subject, '.txt'); 
...
if exist(datafilename)==2
    ...
    if strcmpi(overwrite, 'n')
        ...
        datafilename = strcat('MotorData/WM_Simon_phase2_word_click _', newsub, '.txt');
    end
end
...
% name of data output file 
cursor_data_filename = strcat('MotorData/WM_Simon_phase2_word_click _', subject, '_cursor_data.mat'); 
save(cursor_data_filename, 'cursor_path'); 

velocity_data_filename = strcat('MotorData/WM_Simon_phase2_word_click _', subject, '_velocity_data.mat'); 
save(velocity_data_filename, 'cursor_velocity'); 

cursor_data_filename_probe = strcat('MotorData/WM_Simon_phase2_word_click _', subject, '_cursor_probe_data.mat'); 
save(cursor_data_filename_probe, 'cursor_path_probe'); 

velocity_data_filename_probe = strcat('MotorData/WM_Simon_phase2_word_click _', subject, '_velocity_probe_data.mat'); 
