...
function WM_Simon_phase2_arrow_veloc
...
datafilename = strcat('MotorData/WM_Simon_phase2_arrow_veloc_', subject, '.txt'); 
...
if exist(datafilename)==2
    ...
    if strcmpi(overwrite, 'n')
        ...
        datafilename = strcat('MotorData/WM_Simon_phase2_arrow_veloc_', newsub, '.txt');
    end
end
...
%name of data output file 
cursor_data_filename = strcat('MotorData/WM_Simon_phase2_arrow_veloc_', subject, '_cursor_data.mat'); 
save(cursor_data_filename, 'cursor_path'); 

cursor_data_filename_probe = strcat('MotorData/WM_Simon_phase2_arrow_veloc_', subject, '_cursor_probe_data.mat'); 
