...
function WM_Simon_phase2_word_veloc
...
datafilename = strcat('MotorData/WM_Simon_phase2_word_veloc_', subject, '.txt'); 
...
if exist(datafilename)==2
    ...
    if strcmpi(overwrite, 'n')
        ...
        datafilename = strcat('MotorData/WM_Simon_phase2_word_veloc_', newsub, '.txt');
    end
end
...
%% Specify timing and condition values
    ...
    Yoffset = screenXpixels/4; % should be the same as Xoffset for 4-cue version
...
%% Start task block loop
    ...
    welcome=sprintf('Move to box indicated by color \n green: left \n pink: right \n orange: up \n blue: down \n\nThen, move to box indicated by remembered word\n\n\nPress space to begin the experiment \n \n \n');
            ...
            %WaitSecs(MotorShow); 
                   ...
                   %veloc_thresh = 15; 
                    ...
                    %             Screen('CloseAll')
                        ...
                        if cursor_moved == false && cursor_dist(k) > boundDistance
                            move_init = GetSecs;
                            cursor_moved = true;                           
...
%name of data output file 
cursor_data_filename = strcat('MotorData/WM_Simon_phase2_word_veloc_', subject, '_cursor_data.mat'); 
save(cursor_data_filename, 'cursor_path'); 

cursor_data_filename_probe = strcat('MotorData/WM_Simon_phase2_word_veloc_', subject, '_cursor_probe_data.mat'); 
