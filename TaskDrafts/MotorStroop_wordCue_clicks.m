function MotorStroop_wordCue_clicks
...
datafilename = strcat('MotorData/MotorStroop_wordCue_clicks_', subject, '.txt'); 
...
if exist(datafilename)==2
    ...
    if strcmpi(overwrite, 'n')
        ...
        datafilename = strcat('MotorData/MotorStroop_wordCue_clicks_', newsub, '.txt');
    end
end
...
fprintf(fid, 'subject CurrentCondition TrialType CurrentSampleIndex CurrentSample cueColor correctResp Resp ACC msecRT CurrentProbeMatch ProbeWord correctProbeResp probeResp probeACC probemsecRT\n');
...
%% Start task block loop
    ...
    SampleIndex = Shuffle(SampleIndex);
        ...
        %show WM probe stimulus
            ...
            DrawFormattedText(win, ProbeWord, 'center', 'center', 0);
